          ...
          <div className="space-y-10">
            ...
            <div className="border-b border-[#f3dfda] pb-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-8">
                    Astrology and Vastu are guidance-based sciences.
                    Bajrang Astro does not guarantee specific outcomes.
                    All predictions and remedies are provided in good faith
                    based on your birth chart and property analysis.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="border-b border-[#f3dfda] pb-8">
              ...
              <div className="space-y-5 text-gray-600 leading-8">
                <p>
                  All payments made for Kundli analysis, palm reading,
                  and Vastu consulting are strictly non-refundable and
                  non-returnable under any circumstances.
                </p>

                <p>
                  Once a service is booked and payment is made,
                ...
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-3">
                    <li>
                      ...
                      Once sold and delivered, cannot be returned or
                    ...
                    <li>
                      ...
                      A 3-day return window is available from the date
                      of delivery. The gemstone must be returned in its
                ...
                <p>
                  ...
                  through a proper Kundli consultation before making any purchase.
                </p>
            ...
            <div className="border-b border-[#f3dfda] pb-8">
              ...
              <p className="text-gray-600 leading-8">
                Appointments once booked are subject to availability.
                In case of rescheduling by the client, a minimum
                24-hour notice is required. No refund will be issued
