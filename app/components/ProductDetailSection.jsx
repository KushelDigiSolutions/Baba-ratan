  ...
  return (
    <div className="bg-white min-h-screen" style={fontStyle}>
      ...
      <div className="max-w-[1720px] mx-auto px-[20px] xl:px-[90px] px-5 min-[500px]:px-20 pb-3 pt-8 text-[18px] md:text-[22px] text-[#303030]">
        <Link
          href="/"
          className="font-[300] hover:text-[#E57661] transition-colors"
        >
          Home
        </Link>
      ...
      <div className="max-w-[1720px] mx-auto px-[20px] xl:px-[90px] px-5 min-[500px]:px-20 grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="flex flex-col gap-5">
          <div
            className={`${product.imageBg || "bg-[#F6F1EA]"} rounded-[16px] overflow-hidden h-[360px] flex items-center justify-center`}
          >
            <img
              src={
        ...
        <div className="flex flex-col gap-6">
              ...
              {cartQuantity > 0 ? (
                ...
                <>
                  <div className="w-fit flex items-center border border-gray-200 h-[54px] rounded-md overflow-hidden">
                    <button
                      onClick={() =>
                        handleLocalQuantityChange(localQuantity - 1)
                      }
          ...
          <p className="text-[12px] text-[#303030] font-[500]">
            <span className="font-bold">Note:</span> Free shipping is only
            available when full cart value exceeds $99.99.
          </p>
                  ...
                  <div className="flex flex-col gap-8">
                    ...
                    <div className="flex flex-col gap-6">
                      ...
                      <div className="flex justify-between text-[15px]">
                        ...
                        <span className="text-[#303030] font-medium">
                          {product.physicalAttributes?.cut ||
                            product.cut ||
                            "TBD"}
                        </span>
                      </div>
                      <div className="flex justify-between text-[15px]">
                        ...
                        <span className="text-[#303030] font-medium">
                          {product.physicalAttributes?.origin ||
                            product.origin ||
                  ...
                  <div className="flex flex-col gap-8">
                    ...
                    <div className="flex flex-col gap-6">
                      ...
                      <div className="flex justify-between text-[15px]">
                        ...
                        <span className="text-[#303030] font-medium">
                          {product.vedicDetails?.finger || "TBD"}
                        </span>
                      </div>
                      <div className="flex justify-between text-[15px]">
                        <span className="text-[#303030] font-medium">
                        ...
                        <span className="text-[#303030] font-medium">
                          {product.vedicDetails?.metal || "TBD"}
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html:
                      ...
                      product[activeTab] ||
                      `Information about ${activeTab} will be available soon.`,
                  }}
                />
              </div>
            )}
          ...
          <div className="flex flex-col">
            <div className="bg-[#E57661] rounded-[22px] p-5 min-[500px]:p-8 text-white relative overflow-hidden">
              <h3 className="text-[23px] font-bold mb-3">
                {product.wearingRitual?.title || "Wearing Ritual"}
              </h3>
              <p className="text-white text-[15px] leading-[1.8] font-normal mb-5 opacity-90">
                {product.wearingRitual?.instructions ||
