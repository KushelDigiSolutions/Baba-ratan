    ...
    >
      ...
      <div className="text-center mb-14">
        ...
        <p className="mt-2 text-lg text-gray-600">
          Real people, real results, hear from those who trusted{" "}
          <span className="font-semibold text-black">Bajrang Astro</span>
        </p>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="flex items-center gap-1">
            <p className="text-sm font-semibold text-[#E57661]">{data.name}</p>
            <span className="text-[#E57661] text-xs">
              <img
                src="https://res.cloudinary.com/dd9tagtiw/image/upload/v1767073615/Vertical_container_1_giyzdn.png"
                alt="verified"
                width={15}
                height={15}
              />
