...
const SagittariusPage = () => {
  return (
    <div className="w-full bg-[#fffdf8] overflow-hidden">
      ...
      <section className="relative py-12 sm:py-16 md:py-20 px-4 md:px-10 lg:px-20 bg-gradient-to-br from-[#5b21b6] via-[#7c3aed] to-[#a78bfa] overflow-hidden">
        {/* Glow */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          <div className="flex justify-center order-first lg:order-last">
            <div className="relative w-[220px] h-[220px] sm:w-[320px] sm:h-[320px] md:w-[420px] md:h-[420px] max-w-full rounded-full bg-white/10 border border-white/20 backdrop-blur-xl flex items-center justify-center shadow-2xl">
              ...
              <div className="absolute top-14 right-10 text-white text-4xl animate-bounce">
                ✦
              </div>
      ...
      <section className="py-10 md:py-16 px-4 md:px-10 lg:px-20 bg-white">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-7">
          {luckyThings.map((item, index) => (
            <div
              key={index}
              className="bg-[#fcfaff] border border-[#e9d5ff] rounded-[24px] sm:rounded-[35px] p-5 sm:p-8 hover:shadow-2xl transition hover:-translate-y-2"
            >
      ...
      <section className="py-10 md:py-16 px-4 md:px-10 lg:px-20 bg-gradient-to-r from-[#6d28d9] to-[#a855f7]">
      ...
      <section className="py-10 md:py-16 px-4 md:px-10 lg:px-20">
        ...
        <div className="max-w-4xl mx-auto space-y-4 sm:space-y-6">
          {faqData.map((item, index) => (
            <div
              key={index}
              className="bg-white rounded-[24px] sm:rounded-[30px] border border-[#e9d5ff] p-5 sm:p-8"
            >
      ...
      <section className="pt-4 pb-10 sm:pb-16 px-4 md:px-10 lg:px-20">
        <div className="bg-[#f6efff] border border-[#e9d5ff] rounded-[30px] sm:rounded-[45px] p-6 sm:p-10 md:p-16 text-center relative overflow-hidden">
