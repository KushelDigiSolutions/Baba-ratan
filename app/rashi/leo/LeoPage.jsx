...
const LeoPage = () => {
  return (
    <div className="w-full bg-[#fffaf5] overflow-hidden">
      ...
      <section className="relative py-12 sm:py-16 md:py-20 px-4 md:px-10 lg:px-20 bg-gradient-to-br from-[#d97706] via-[#f59e0b] to-[#fbbf24] overflow-hidden">
        {/* Glow */}
      ...
      <section className="py-10 md:py-16 px-4 md:px-10 lg:px-20 bg-gradient-to-r from-[#d97706] to-[#fbbf24]">
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 md:px-10 lg:px-20 bg-[#fffaf5]">
      ...
      <section className="pt-4 pb-10 sm:pb-16 px-4 md:px-10 lg:px-20">
        <div className="bg-[#fff5dd] border border-[#fde7ba] rounded-[30px] sm:rounded-[45px] p-6 sm:p-10 md:p-16 text-center relative overflow-hidden">
