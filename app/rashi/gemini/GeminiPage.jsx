        ...
        <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          <div className="flex justify-center order-first lg:order-last">
            <div className="relative w-[220px] h-[220px] sm:w-[320px] sm:h-[320px] md:w-[420px] md:h-[420px] max-w-full rounded-full overflow-hidden flex items-center justify-center shadow-2xl">
              <img src="https://res.cloudinary.com/dlzxiy0tl/image/upload/v1780578315/Palm_Reading_Expert_India_Vishal_Verma_Bajrang_Astro_gemini_zodiac_il9bgr.png" alt="Gemini Mithun Rashi Vedic Astrology India — Bajrang Astro" className="w-full h-full object-cover scale-[1.18]" style={{ clipPath: "circle(42.5%)" }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 lg:py-16 px-4 md:px-10 lg:px-20">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-14 items-center">
          ...
          <div className="relative">
            <img
              src="https://res.cloudinary.com/dlzxiy0tl/image/upload/v1781073295/Gemini_Mithun_Rashi_Vedic_Astrology_India_Bajrang_Astro_m5h1f4.avif"
      ...
      <section className="py-12 lg:py-16 px-4 md:px-10 lg:px-20 bg-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-7">
          {luckyThings.map((item, index) => (
            <div
              key={index}
              className="bg-[#fffaf0] border border-[#f3e3ba] rounded-[24px] sm:rounded-[35px] p-5 sm:p-8 hover:shadow-2xl transition hover:-translate-y-2 flex flex-col items-center text-center sm:items-start sm:text-left"
            >
      ...
      <section className="py-12 lg:py-16 px-4 md:px-10 lg:px-20 bg-gradient-to-r from-[#e57661] to-[#e57661]">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-14 items-center">
          ...
          <div className="relative order-first lg:order-last">
            <img
              src="https://res.cloudinary.com/dlzxiy0tl/image/upload/v1781073296/Gemini_Rashi_Personality_Traits_India_Vishal_Verma_e4x8yp.avif"
      ...
      <section className="py-12 lg:py-16 px-4 md:px-10 lg:px-20">
        ...
        <div className="max-w-4xl mx-auto space-y-4 sm:space-y-6">
          {faqData.map((item, index) => (
            <div
              key={index}
              className="bg-white rounded-[24px] sm:rounded-[30px] border border-[#f1e2b7] p-5 sm:p-8 text-center md:text-left flex flex-col items-center md:items-start"
            >
