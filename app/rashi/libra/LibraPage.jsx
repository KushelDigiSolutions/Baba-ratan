...
const LibraPage = () => {
  return (
    <div className="w-full bg-[#fffcfd] overflow-hidden">
      ...
      <section className="relative py-12 sm:py-16 md:py-20 px-4 md:px-10 lg:px-20 bg-gradient-to-br from-[#ec4899] via-[#f43f5e] to-[#fda4af] overflow-hidden">
        {/* Glow */}
      ...
      <section className="py-10 md:py-16 px-4 md:px-10 lg:px-20 bg-white">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-7">
          {luckyThings.map((item, index) => (
            <div
              key={index}
              className="bg-[#fff8fb] border border-[#f5d5e6] rounded-[24px] sm:rounded-[35px] p-5 sm:p-8 hover:shadow-2xl transition hover:-translate-y-2"
            >
      ...
      <section className="py-10 md:py-16 px-4 md:px-10 lg:px-20 bg-gradient-to-r from-[#d16ba5] to-[#f3a7cf]">
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 md:px-10 lg:px-20 bg-[#fffafb]">
      ...
      <section className="py-10 md:py-16 px-4 md:px-10 lg:px-20">
        ...
        <div className="max-w-4xl mx-auto space-y-4 sm:space-y-6">
          {faqData.map((item, index) => (
            <div
              key={index}
              className="bg-white rounded-[24px] sm:rounded-[30px] border border-[#f5d5e6] p-5 sm:p-8"
            >
      ...
      <section className="pt-4 pb-10 sm:pb-16 px-4 md:px-10 lg:px-20">
        <div className="bg-[#fff0f7] border border-[#f5d5e6] rounded-[30px] sm:rounded-[45px] p-6 sm:p-10 md:p-16 text-center relative overflow-hidden">
