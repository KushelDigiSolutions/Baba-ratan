...
export const metadata = {
    ...
    description:
        "Get trusted Vedic astrology in India consultation & accurate Janam Kundli analysis from Pandit Vishal Johari at Bajrang Astro, an expert astrologer in India. Book now",
    alternates: {
