        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid lg:grid-cols-2 gap-16 items-center relative z-10">
          ...
          >
            ...
            <div className="flex flex-wrap gap-5 mt-10">
              <button className="bg-white text-[#1e293b] px-8 py-4 rounded-2xl font-bold shadow-xl hover:scale-105 transition-all duration-300 flex items-center gap-2">
                Talk to Astrologer <ArrowRight size={18} />
              </button>

              <button className="border border-white/30 bg-white/5 backdrop-blur-md px-8 py-4 rounded-2xl font-semibold hover:bg-white/10 transition-all">
                View Remedies
              </button>
            </div>
          </motion.div>
        ...
        <div className="max-w-5xl mx-auto text-center px-6 relative z-10">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <button className="bg-blue-600 border border-white/30 hover:bg-blue-700 text-white px-10 py-5 rounded-3xl font-bold text-lg shadow-2xl transition-all hover:scale-105">
                Book Consultation
              </button>
              <button className="border border-white/30 text-white hover:bg-white/10 px-10 py-5 rounded-3xl font-bold text-lg transition-all">
                Contact Support
              </button>
            </div>
          </motion.div>
